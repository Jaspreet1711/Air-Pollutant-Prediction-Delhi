# -*- coding: utf-8 -*-
"""
Created on Tue Dec 28 21:54:14 2021
...
a = -60
Ridge = Ridge(alpha = a, max_iter = 100, tol = 0.1)
Ridge.fit(X_Train, y_Train)

# R Sqaure of model on both Train and Test sets.
print("Ridge Regression Used with alpha: "+str(a))
print("R-Sqaure using all 10 features: ")
print(" ")
print("R-Sqaure on Train Set = "+str(np.round(Ridge.score(X_Train, y_Train), 2)))
print(" ")
print("R-Sqaure on Test Set = "+str(np.round(Ridge.score(X_Test, y_Test), 2)))
print(" ")
