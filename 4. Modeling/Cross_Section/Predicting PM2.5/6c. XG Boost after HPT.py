# -*- coding: utf-8 -*-
"""
Created on Tue Jan  4 08:30:05 2022
...
xgb = XGBRegressor(subsample = 0.6, n_estimators = 100, min_child_weight = 5, max_depth = 10, learning_rate = '0.05', random_state = 21)

# Fitting the RandomForest Regression model on Train Data.
xgb.fit(X_Train, y_Train)

# R Sqaure of model on both Train and Test sets.
print("XG Boost Regression Used after HPT")
